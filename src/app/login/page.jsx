  ...
  return (
    <Card className="border mx-auto w-125 py-10 mt-5 shadow-lg">
      ...
      <div className="px-10 mb-4">
        <Button onClick={handleGoogleLoginIn} className="w-full border-2 bg-white text-black font-medium">
          <FaGoogle /> Sign In With Google
        </Button>
      </div>
      <p className="text-center text-sm text-gray-600">
        Don't have an account?{' '}
        <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-green-700 font-bold hover:underline">
          Register here
        </Link>
      </p>
    </Card>
